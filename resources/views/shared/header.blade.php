        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light px-0 py-3">
                <a href="{{ route('home') }}" aria-label="{{ config('settings.title') }}" class="navbar-brand p-0">
                    <div class="logo">
                        <img src="{{ url('/') }}/uploads/brand/{{ (request()->cookie('dark_mode') == 1 ? config('settings.logo_dark') : config('settings.logo')) }}" alt="{{ config('settings.title') }}" data-theme-dark="{{ url('/') }}/uploads/brand/{{ config('settings.logo_dark') }}" data-theme-light="{{ url('/') }}/uploads/brand/{{ config('settings.logo') }}" data-theme-target="src">
                    </div>
                </a>
                ...
                <div class="collapse navbar-collapse" id="header-navbar">
                    <ul class="navbar-nav pt-2 p-lg-0 {{ (__('lang_dir') == 'rtl' ? 'mr-auto' : 'ml-auto') }}">
                        @if(config('settings.tools_guest'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('tools') }}" role="button">{{ __('Tools') }}</a>
                            </li>
                        @endif
...
@else
    ...
    <nav class="slide-menu shadow bg-base-0 navbar navbar-light p-0 d-flex flex-column z-1030 d-print-none" id="slide-menu">
