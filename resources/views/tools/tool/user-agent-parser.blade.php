        ...
        <div class="card-body mb-n3">
            <div class="row mx-n2">
                <div class="col-12 col-md-6 px-2">
                    <div class="form-group">
                        ...
                        <input id="i-result-browser" class="form-control" type="text"
                               value="{{ $result->browser->name ?? null }} {{ $result->browser->version->value ?? null }}"
                               readonly>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 px-2">
                    <div class="form-group">
                        ...
                        <input id="i-result-operating-system" class="form-control" type="text"
                               value="{{ $result->os->name ?? null }} {{ $result->os->version->value ?? null }}"
                               readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="position-relative">
                    <textarea id="i-result-user-agent" class="form-control" onclick="this.select();"
                              readonly>{{ $userAgent ?? null }}</textarea>
                    ...
                    <div class="position-absolute top-0 right-0">
                        <div class="btn btn-sm btn-primary m-2" data-tooltip-copy="true" title="{{ __('Copy') }}"
                             ...
                             data-clipboard="true" data-clipboard-target="#i-result-user-agent">{{ __('Copy') }}</div>
                    </div>
                </div>
            </div>
        </div>
