@section('site_title', formatTitle([__('Text reverser'), __('Tool'), config('settings.title')]))
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('tools.text_reverser') }}" method="post" enctype="multipart/form-data">
            @csrf
