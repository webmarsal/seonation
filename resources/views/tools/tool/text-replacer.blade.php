@section('site_title', formatTitle([__('Text replacer'), __('Tool'), config('settings.title')]))
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('tools.text_replacer') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mx-n2">
                ...
                <div class="col-auto px-2">
                    <a href="{{ route('tools.text_replacer') }}" class="btn btn-outline-secondary ml-auto">{{ __('Reset') }}</a>
                </div>
            </div>
        </form>
    </div>
