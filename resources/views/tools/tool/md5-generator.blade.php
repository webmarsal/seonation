@section('site_title', formatTitle([__('MD5 generator'), __('Tool'), config('settings.title')]))
...
<div class="d-flex">
    <h1 class="h2 mb-3 text-break">{{ __('MD5 generator') }}</h1>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header align-items-center">
        <div class="row">
            <div class="col">
                <div class="font-weight-medium py-1">{{ __('MD5 generator') }}</div>
            </div>
        </div>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('tools.md5_generator') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mx-n2">
                ...
                <div class="col-auto px-2">
                    <a href="{{ route('tools.md5_generator') }}" class="btn btn-outline-secondary ml-auto">{{ __('Reset') }}</a>
                </div>
            </div>
        </form>
    </div>
