...
<div class="d-flex">
    <h1 class="h2 mb-3 text-break">{{ __('CSS minifier') }}</h1>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header align-items-center">
        <div class="row">
            <div class="col">
                <div class="font-weight-medium py-1">{{ __('CSS minifier') }}</div>
            </div>
        </div>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('tools.css_minifier') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mx-n2">
                ...
                <div class="col-auto px-2">
                    <a href="{{ route('tools.css_minifier') }}" class="btn btn-outline-secondary ml-auto">{{ __('Reset') }}</a>
                </div>
            </div>
        </form>
    </div>
