...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('tools.indexed_pages_checker') }}" method="post" enctype="multipart/form-data"
              id="indexed-pages-checker-form">
            @csrf
            ...
            <div class="row mx-n2">
                <div class="col px-2">
                    @if(config('settings.captcha_indexed_pages_checker'))
                        {!! NoCaptcha::displaySubmit('indexed-pages-checker-form', __('Search'), ['data-theme' => (Cookie::get('dark_mode') == 1 ? 'dark' : 'light'), 'data-size' => 'invisible', 'class' => 'btn ' . ($errors->has('g-recaptcha-response') ? 'btn-danger' : 'btn-primary')]) !!}
