...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('admin.dashboard.index', ['stats' => $stats, 'users' => $users, 'payments' => $payments, 'reports' => $reports]);
    }
    ...
    public function indexReports(Request $request)
    {
        ...
        return view('admin.container', ['view' => 'admin.reports.list', 'reports' => $reports, 'filters' => $filters]);
    }
    ...
    public function editReport($id)
    {
        ...
        return view('admin.container', ['view' => 'reports.edit', 'report' => $report]);
    }
